...
public class MultiSearchDialog extends javax.swing.JDialog {
    private final String[] critereStrings = {java.util.ResourceBundle.
            getBundle("MessageBundle").getString("AUCUN"),
        java.util.ResourceBundle.getBundle("MessageBundle").
            getString("EGALE À"),java.util.ResourceBundle.
                    getBundle("MessageBundle").getString("CONTIENT"),
        java.util.ResourceBundle.getBundle("MessageBundle").
                getString("COMMENCE PAR"), java.util.ResourceBundle.
                        getBundle("MessageBundle").getString("SE TERMINE PAR")};
     ...
     * WARNING: Do NOT modify th is code. The content of this method is always
    ...
    private void initComponents() {
        ...
        titleLabel.setFont(new java.awt.Font("Simplified Arabic", 1, 48)); // NOI18N
        ...
        jLabel2.setText(bundle.getString("TABLE")); // NOI18N
        ...
        jLabel3.setText(bundle.getString("CHAMP")); // NOI18N

        fieldComboBox.setModel(fieldModel);

        jLabel4.setText(bundle.getString("CRITÈRE")); // NOI18N
        ...
        jLabel5.setText(bundle.getString("RECHERCHE")); // NOI18N
        ...
        searchButton.setText(bundle.getString("CHERCHER")); // NOI18N
        ...
        columnCountLabel.setFont(new java.awt.Font("Simplified Arabic", 1, 24)); // NOI18N
        ...
        rowCountLabel.setFont(new java.awt.Font("Simplified Arabic", 1, 24)); // NOI18N
    ...
    private void updateScrollPane(){
        ...
        if (itemExist){
            ...
            for (int i = 0; i < table.getColumnCount(); i++) {
                ...
                if (column.getHeaderValue().equals("NOM")
                        || column.getHeaderValue().equals(java.util.
        ...
        scrollPane.setViewportView(table);
        rowCountLabel.setText(java.text.MessageFormat.format(java.util.
                ResourceBundle.getBundle("MessageBundle").
                getString("LIGNES : {0}"), new Object[] {model.getRowCount()}));
        columnCountLabel.setText(java.text.MessageFormat.format(java.util.
                ResourceBundle.getBundle("MessageBundle").
                getString("COLONNES : {0}"), new Object[] {model.getColumnCount()}));
    }
