...
public class ListFrame extends javax.swing.JDialog {
    ...
    private Boolean popupItemState= false;
    /**
    ...
    public ListFrame(JFrame frm,Operation op){
        ...
        initComponents();
        operation = op;
        if ((operation != Operation.CUSTOMER)&&(operation != Operation.PROVIDER)){
            popupMenu.remove(PaymentMenuItem);
        }
        if (operation != Operation.PRODUCT)
            popupMenu.remove(FullStockMenuItem);
        init();
    }
...
/**
    ...
    private void initComponents() {
        ...
        FullStockMenuItem = new javax.swing.JMenuItem();
        ...
        FullStockMenuItem.setText(bundle1.getString("STOCK PLEIN")); // NOI18N
        FullStockMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                FullStockMenuItemActionPerformed(evt);
            }
        });
        popupMenu.add(FullStockMenuItem);

        SearchMenuItem.setText(bundle1.getString("SEARCH")); // NOI18N
...
//            break;
    ...
    private void FullStockMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FullStockMenuItemActionPerformed
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                popupItemState = !popupItemState;
                search(popupItemState); 
                System.out.println(popupItemState);
            }
        });         
    }//GEN-LAST:event_FullStockMenuItemActionPerformed
    ...
    private javax.swing.JMenuItem FullStockMenuItem;
